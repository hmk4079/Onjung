...
const showList = ({ lists, pagination }) => {
    ...
    if (!Array.isArray(lists) || lists.length === 0) {
        ...
        lists.forEach((list) => {
            ...
            // 리스트 항목 HTML 생성
            layText += `
                <a href="/volunteer/volunteer-inquiry/${list.id}" class="volunteer-list-a">
                    <div class="contest-info">
                        ...
                        <div class="contest-info-bottom">
                            ...
                            <div class="contest-info-bottom-user-nick">
                                ${list.memberName != null ? list.memberName : (list.memberNickName != null ? list.memberNickName : '닉네임없음')}
                            </div>
